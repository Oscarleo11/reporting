...
<div class="section">
    <div class="section-header">
        <h1><i class="fas fa-money-check-alt text-primary mr-2"></i> Utilisation de chèque</h1>
        <div class="section-header-breadcrumb">
            <a href="{{ route('utilisationcheque.index') }}" class="btn btn-outline-primary btn-sm">
                                            ...
                                            <div class="form-group col-md-6">
                                                ...
                                                <select name="details[0][code]" class="form-control" required>
                                                    ...
                                                    @foreach ($familles as $UpCheque)
                                                        <option value="{{ $UpCheque->code }}">{{ $UpCheque->code }}</option>
                                                    @endforeach
                                                </select>
                                            </div>
                                            <div class="form-group col-md-6">
