                                    ...
                                    <div class="card-body">
                                        <div class="form-row">
                                            <div class="form-group col-md-6">
                                                ...
                                                <input type="text" name="services[0][operateur]" class="form-control" required>
                                            </div>
                                            <div class="form-group col-md-6">
                                            ...
                                            <div class="form-group col-md-6">
                                                ...
                                                <input type="number" name="services[0][nbsous_agents]" class="form-control" required>
                                            </div>
                                            <div class="form-group col-md-6">
                                                <label>Points de service</label>
                                                <input type="number" name="services[0][nbpoints_service]" class="form-control" required>
                                            </div>
                                            <div class="form-group col-md-12">
                                                <label>Description</label>
                                                <input type="text" name="services[0][description_service]" class="form-control">
                                            </div>
                                            <div class="form-group col-md-6">
                                                <label>Date de lancement</label>
                                                <input type="date" name="services[0][date_lancement]" class="form-control">
                                            </div>
                                            <div class="form-group col-md-6">
                                                <label>Périmètre</label>
                                                <input type="text" name="services[0][perimetre]" class="form-control">
                                            </div>
                                            <div class="form-group col-md-12">
                                                <label>Mécanisme de compensation</label>
                                                <input type="text" name="services[0][mecanisme_compensation_reglement]" class="form-control">
                                            </div>
                                        </div>
                                        ...
                                        <div class="transactions-container">
                                            <div class="row transaction-row">
                                                <div class="form-group col-md-4">
                                                    ...
                                                    <select name="services[0][transactions][0][type_transaction]" class="form-control" required>
                                                ...
                                                <div class="form-group col-md-4">
                                                    ...
                                                    <input type="text" name="services[0][transactions][0][mode_envoi]" class="form-control">
                                                </div>
                                                <div class="form-group col-md-4">
                                                    <label>Mode de réception</label>
                                                    <input type="text" name="services[0][transactions][0][mode_reception]" class="form-control">
                                                </div>
                                                <div class="form-group col-md-3">
                                                    <label>Nombre intra</label>
                                                    <input type="number" name="services[0][transactions][0][nb_intra]" class="form-control" required>
                                                </div>
                                                <div class="form-group col-md-3">
                                                    <label>Valeur intra</label>
                                                    <input type="number" name="services[0][transactions][0][valeur_intra]" class="form-control" required>
                                                </div>
                                                <div class="form-group col-md-3">
                                                    <label>Nombre hors</label>
                                                    <input type="number" name="services[0][transactions][0][nb_hors]" class="form-control" required>
                                                </div>
                                                <div class="form-group col-md-3">
                                                    <label>Valeur hors</label>
                                                    <input type="number" name="services[0][transactions][0][valeur_hors]" class="form-control" required>
                                                </div>
                                        ...
                                        <div class="text-right mt-2">
                                            <button type="button" class="add-transaction btn btn-outline-primary btn-sm">
                                                <i class="fas fa-plus"></i> Ajouter une transaction
                                            </button>
                                        </div>
                                        <div class="text-right mt-2">
                                            <button type="button" onclick="removeService(this)" class="btn btn-link text-danger">
