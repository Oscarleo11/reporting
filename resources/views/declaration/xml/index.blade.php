                        ...
                        <form method="POST" action="{{ route('declaration.xml.preview') }}">
                            ...
                            <div class="form-row">
                                ...
                                <div class="form-group col-md-4">
                                    ...
                                    <input type="date" name="debut_periode" value="{{ old('debut_periode', $debut_periode ?? '') }}" class="form-control" required>
                                </div>
                                <div class="form-group col-md-4">
                                    <label>Fin période</label>
                                    <input type="date" name="fin_periode" value="{{ old('fin_periode', $fin_periode ?? '') }}" class="form-control" required>
                                </div>
                            </div>
                ...
                @isset($donnees)
                    <div class="card shadow-sm border-0">
                        ...
                        <div class="card-body">
                            ...
                            @else
                                <div class="mb-4">
                                    <h6 class="font-weight-bold">Aperçu des données ({{ $donnees->count() }} enregistrements)</h6>
