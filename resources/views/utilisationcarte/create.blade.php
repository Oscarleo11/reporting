...
@section('title', 'Utilisation de cartes')
@section('content')
<div class="section">
    <div class="section-header">
        <h1><i class="fas fa-credit-card text-primary mr-2"></i> Utilisation de cartes</h1>
        <div class="section-header-breadcrumb">
            <a href="{{ route('utilisationcarte.index') }}" class="btn btn-outline-primary btn-sm">
        ...
        <div class="row justify-content-center">
            <div class="col-lg-10">
                <div class="card shadow-sm border-0">
                    <div class="card-body">
                        <form method="POST" action="{{ route('utilisationcarte.store') }}">
                            @csrf
                            ...
                            <h5 class="mb-3 font-weight-bold text-primary">Détails d'utilisation</h5>
                                ...
                                <div class="card mb-3 detail-row border border-primary">
                                    <div class="card-body">
                                        <div class="form-row">
                                            <div class="form-group col-md-6">
                                                ...
                                                <select name="details[0][code]" class="form-control" required>
                                                    ...
                                                    @foreach ($familles as $UpCarte)
                                                        <option value="{{ $UpCarte->code }}">{{ $UpCarte->code }}</option>
                                                    @endforeach
                                                </select>
                                            </div>
                                            <div class="form-group col-md-6">
                                        ...
                                        <div class="text-right">
                                            <button type="button" onclick="removeRow(this)" class="btn btn-link text-danger">
