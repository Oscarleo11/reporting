                    ...
                    <div class="card shadow-sm border-0">
                        ...
                        <div class="card-body">
                            <div class="row text-center">
                                ...
                                <div class="col-md-2 mb-3">
                                    <a href="{{ route('reclamationstra.index') }}"
                                ...
                                <div class="col-md-2 mb-3">
                                    <a href="{{ route('annuairestra.index') }}"
                ...
                <div class="col-md-8 mb-4">
                    <div class="card shadow-sm border-0 h-100">
                        <div class="card-header bg-white">
                            <i class="fas fa-chart-line text-primary mr-2"></i> Évolution des opérations STRA (12 derniers
                            mois)
                        </div>
                        <div class="card-body">
            ...
            <div class="row mt-4">
                <div class="col-md-12">
                    <div class="alert alert-info shadow-sm">
                        ...
                        Bienvenue sur la plateforme de reporting STRA. Utilisez le menu ou les accès rapides pour naviguer
