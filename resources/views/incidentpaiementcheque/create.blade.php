...
@section('title', 'Incidents de paiement sur chèque')
@section('content')
<div class="section">
    <div class="section-header">
        <h1><i class="fas fa-money-check-alt text-primary mr-2"></i> Incidents de paiement sur chèque</h1>
        <div class="section-header-breadcrumb">
            <a href="{{ route('incidentpaiementcheque.index') }}" class="btn btn-outline-primary btn-sm">
        ...
        <div class="row justify-content-center">
            <div class="col-lg-10">
                <div class="card shadow-sm border-0">
                    ...
                    <div class="card-body">
                        <form method="POST" action="{{ route('incidentpaiementcheque.store') }}">
                            @csrf
                                        ...
                                        <div class="form-row">
                                            <div class="form-group col-md-6">
                                                ...
                                                <select name="details[0][code]" class="form-control" required>
                                                    ...
                                                    @foreach ($familles as $IpCheque)
                                                        <option value="{{ $IpCheque->code }}">{{ $IpCheque->code }}</option>
                                                    @endforeach
                                                </select>
                                            </div>
                                            <div class="form-group col-md-6">
